...
export class AddEmailTemplateComponent implements OnInit {
  title: any = 'Create EmailTemplate';
  sportLogo = '';
  tempFile: any = '';
  sport_img: any;
  districtList: any;
  ...
  constructor(
    ...
    private sportService: EmailTemplatesService,
  ...
  ngOnInit() {
    if (this.router.url !== '/email-templates/add') {
      this.activeRouteSubscriber = this.activatedRoute.queryParams.subscribe(
        param => {
          this.editEmailTemplateId = param.editEmailTemplateId;
        }
      );
      this.getOneEmailTemplate(this.editEmailTemplateId);
    }
  }
  ...
  getOneEmailTemplate(id: any) {
    ...
    this.isEdit = true;
    this.showImage = true;
    this.title = 'Edit EmailTemplate';
    this.sportService
      .getOneEmailTemplate(id)
      .then((res: any) => {
        this.sport = res.data;      
  ...
  updateEmailTemplate() {
    ...
    this.sportService
      .updateEmailTemplate(this.editEmailTemplateId, temp)
      .then((e: any) => {
        // this.formatMobile();
        this.sharedService.showLoader = false;
        ...
        headerRef.changeLogo(e.data.logo, this.editEmailTemplateId);
        // this.sharedService.updatedEmailTemplateData(localStorage.super_cur_sportLogo);
        this.sharedService
